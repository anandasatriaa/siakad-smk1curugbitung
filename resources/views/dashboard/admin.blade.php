                            ...
                            <div class="col-md-4">
                                ...
                                <select name="periode_id" id="periode_id" class="form-select" onchange="this.form.submit()">
                                    @foreach ($semuaPeriode as $p)
                                        <option value="{{ $p->id }}"
                                            {{ optional($aktifPeriode)->id == $p->id ? 'selected' : '' }}>
                    ...
                    <div class="d-flex align-items-end row">
                        <div class="col-sm-7">
                            <div class="card-body">
                                ...
                                <p class="mb-4">
                                    @if ($aktifPeriode)
                                        Menampilkan data periode: <span class="fw-bold">{{ $aktifPeriode->tahun_ajaran }} -
                                            {{ ucfirst($aktifPeriode->semester) }}</span>
                                    @else
                                ...
                                <tbody>
                                    @forelse($distribusiSiswa as $kelas)
                                        <tr>
                                            ...
                                            <td><span class="badge bg-label-primary">{{ $kelas->siswa_count }}
                                                    Siswa</span></td>
                                        </tr>
                                    @empty
                                        <tr>
                                            <td colspan="3" class="text-center">Tidak ada data kelas untuk periode
                                                ini.</td>
                                        </tr>
                                    @endforelse
                                </tbody>
